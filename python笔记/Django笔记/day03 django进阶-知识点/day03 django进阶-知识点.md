...
![image-20220703100004360](image-20220703100004360.png)

![image-20220703100634467](image-20220703100634467.png)



### 1.3 常用语法

![image-20220703104019949](image-20220703104019949.png)
...
![image-20220703104857782](image-20220703104857782.png)



### 1.5 自定义模板功能

![image-20220703110604253](image-20220703110604253.png)
...
![image-20220703112043922](image-20220703112043922.png)



### 1.6 继承和母版

![image-20220703114930894](image-20220703114930894.png)

![image-20220703114941168](image-20220703114941168.png)



### 1.7 模板的导入

![image-20220703115519438](image-20220703115519438.png)
...
![image-20220703140649928](image-20220703140649928.png)
...
![image-20220703141259948](image-20220703141259948.png)

![image-20220703141313488](image-20220703141313488.png)



### 2.2 MiddlewareMixin（建议）

![image-20220703142923194](image-20220703142923194.png)

![image-20220703142936794](image-20220703142936794.png)
...
![image-20220703145219921](image-20220703145219921.png)

![image-20220703145158733](image-20220703145158733.png)



![image-20220703145210733](image-20220703145210733.png)
...
![image-20220703151639813](image-20220703151639813.png)

### 2.3 其他

![image-20220703153559256](image-20220703153559256.png)

![image-20220703153616241](image-20220703153616241.png)
...
![image-20220703155414569](image-20220703155414569.png)
...
![image-20220703155844071](image-20220703155844071.png)
...
- 命令，django根据models中类生成一个 `对数据库操作的配置文件` => `migrations`
  ...
  ![image-20220703160914596](image-20220703160914596.png)
...
- 命令，读取已经注册么给app中的migrations目录将配置文件  -> 转换成：生成表，修改表 SQL -> 连接数据库去运行。
  ...
  ![image-20220703162050698](image-20220703162050698.png)
...
![image-20220703173556969](image-20220703173556969.png)

![image-20220703174433414](image-20220703174433414.png)





![image-20220703175051329](image-20220703175051329.png)

![image-20220703175312854](image-20220703175312854.png)



![image-20220703175556444](image-20220703175556444.png)
